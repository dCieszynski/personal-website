...
function Navbar({ links }: Props) {
  return (
    <div className="fixed w-screen font-imb font-bold text-sm z-50">
      <div className="-z-10 bg-black border-b-2 border-black h-[80px] absolute w-full rounded drop-shadow-brutal" />
